...
const EditProject = ({project, setRowChange, courseInfo}) => {
    ...
    const handleClose = () => {
        ...
        setProjectTeamLead(project.project_team_lead);
    ...
    const updateProject = async e => {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:5000/projects/projects/${project.project_id}`, {method: "PUT", headers: myHeaders, body: JSON.stringify(body)});
