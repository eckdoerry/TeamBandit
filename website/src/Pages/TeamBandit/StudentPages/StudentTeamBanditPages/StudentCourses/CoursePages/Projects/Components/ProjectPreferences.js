...
const ProjectPreferences = ({studentInfo, rows, setRowChange}) => {
    ...
    return(
        <div>
            ...
            <div>
                ...
                <Button sx={{ m: 2 }} variant="contained" color="warning" onClick = {(e) => (handleClose(), updatePreferences(e))}> Update </Button>
